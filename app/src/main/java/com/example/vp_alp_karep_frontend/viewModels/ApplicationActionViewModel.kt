...
class ApplicationActionViewModel(
    ...
    fun applyJob(token: String, jobId: Int) {
        ...
        call.enqueue(object : Callback<GeneralResponseModel> {
            override fun onResponse(
               ...
               if(response.isSuccessful) {
                   ...
                   _applyState.value = ApplicationActionUiState.Error("Error ${response.code()}")
               }
            }

            override fun onFailure(call: Call<GeneralResponseModel?>, t: Throwable) {
                _applyState.value = ApplicationActionUiState.Error(t.localizedMessage ?: "Network Error")
            }
        })
    }
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                ApplicationActionViewModel(repo)
            }
        }
    }
}